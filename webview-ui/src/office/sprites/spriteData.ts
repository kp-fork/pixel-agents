...
function makeSolidSprite(width: number, height: number, color: string): SpriteData {
  return Array.from({ length: height }, () => Array.from({ length: width }, () => color));
}

export const DESK_SQUARE_SPRITE: SpriteData = makeSolidSprite(32, 24, '#6b4f2a');
export const BOOKSHELF_SPRITE: SpriteData = makeSolidSprite(16, 32, '#8a6b3f');
export const PLANT_SPRITE: SpriteData = makeSolidSprite(16, 16, '#4d8a3b');
export const COOLER_SPRITE: SpriteData = makeSolidSprite(16, 16, '#7aa7c7');
export const WHITEBOARD_SPRITE: SpriteData = makeSolidSprite(32, 16, '#d8d8d8');
export const CHAIR_SPRITE: SpriteData = makeSolidSprite(16, 16, '#556b7a');
export const PC_SPRITE: SpriteData = makeSolidSprite(16, 16, '#4b5563');
export const LAMP_SPRITE: SpriteData = makeSolidSprite(16, 16, '#f2d16b');
